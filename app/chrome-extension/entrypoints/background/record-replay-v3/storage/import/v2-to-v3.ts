...
function convertNodeV2ToV3(v2Node: V2Node): NodeV3 | null {
  ...
  const node: NodeV3 = {
    ...
    config: (v2Node.config ?? {}) as unknown as JsonObject,
  };
...
export function convertTriggerV2ToV3(v2Trigger: V2Trigger): ConversionResult<TriggerSpec> {
  ...
  switch (v2Trigger.type) {
    ...
    case 'element':
      if (!v2Trigger.selector) {
        warnings.push('Element trigger missing selector, converting to manual');
        trigger = {
          id: v2Trigger.id,
          kind: 'manual',
          flowId: v2Trigger.flowId as FlowId,
      ...
      trigger = {
        ...
        ...(v2Trigger.appear !== undefined ? { appear: v2Trigger.appear } : {}),
        ...(v2Trigger.once !== undefined ? { once: v2Trigger.once } : {}),
        ...(v2Trigger.debounceMs !== undefined ? { debounceMs: v2Trigger.debounceMs } : {}),
      };
      break;
