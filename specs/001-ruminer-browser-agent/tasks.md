...
- [x] T026 [US2] Remove platform-specific scan/extract node kinds from Ruminer ingest plugin registration to enforce workflow-level extraction in `/Users/tcai/Projects/Ruminer/ruminer-browser-agent/app/chrome-extension/entrypoints/background/record-replay-v3/engine/plugins/ruminer-ingest/index.ts`
